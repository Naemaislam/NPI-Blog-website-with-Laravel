            ...
            <div class="app-menu">
                <ul class="accordion-menu">
                    ...
                    <li class="{{ \Request::route()->getName() == 'tag' ? 'active-page' : '' }}">
                        <a href="{{ route('tag') }}" class="active"><i
                                class="material-icons-two-tone">tag</i>Tags</a>
                   @if (auth()->user()->role == 'admin' || auth()->user()->role == 'modarator')
                     </li>
                     <li class="{{ \Request::route()->getName() == 'role.view' ? 'active-page' : '' }}">
                         <a href="{{ route('role.view') }}" class="active"><i class="bi bi-person-up"></i>Role Manager</a>
                     </li>

                   @endif

                   <li class="{{(\Request::route()->getName() == 'banner' || 'banner.create.view') ? 'active-page' : ''}}" >
                    <a href=""><i class="material-icons-two-tone">inventory_2</i>Banner<i
                    ...
                    <ul class="sub-menu">
                        ...
                        <li>
                            <a href="{{ route('banner.create.view')}}">Banner Create</a>
                        </li>
                ...
                @endphp
                    ...
                    <li class="{{ \Request::route()->getName() == 'blog' || 'blog.create.view' ? 'active-page' : '' }}">
                        <a href=""><i class="material-icons-two-tone">compost</i>Blogs-{{ $count}}<i
                                class="material-icons has-sub-menu">keyboard_arrow_right</i></a>
                        <ul class="sub-menu">
                            <li>
                            ...
                            <li>
                                <a href="{{ route('blog.create.view')}}">Blogs Create</a>
                            </li>
                ...
                @endphp --}}
                    ...
                    <li class="{{ \Request::route()->getName() == 'shop' || 'shop.create.view' ? 'active-page' : '' }}">
                        <a href=""><i class="material-icons-two-tone">compost</i>Shop<i
                                class="material-icons has-sub-menu">keyboard_arrow_right</i></a>
                        <ul class="sub-menu">
                            <li>
                            ...
                            <li>
                                <a href="{{ route('shop.create.view')}}">Products Create</a>
                            </li>
                            ...
                            <ul class="navbar-nav">
                                <li class="nav-item hidden-on-mobile">
                                    <form method="POST" action="{{ route('logout') }}">
                                        @csrf
                                        <button type="submit" class="nav-link active btn btn-success btn-xs mt-2"><i
                                                class="material-icons-two-tone ms-1">logout</i>LOGOUT</button>
                                    </form>
                                </li>
                                ...
                                <li class="nav-item hidden-on-mobile">
                                    <a class="nav-link language-dropdown-toggle" href="#" id="languageDropDown"
                                        ...
                                        <img src="{{ asset('dashboard_assets') }}/assets/images/flags/us.png" alt=""></a>
